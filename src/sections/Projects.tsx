...
export function Projects({ onSelect }: { onSelect: (p: Project) => void }) {
  ...
  // pre-roll: mount ~1 viewport before entry, unmount ~1 viewport after exit
  ...
  return (
    <section ref={ref} id="projects" className="relative">
      <div className="relative h-screen">
        ...
        <p className="pointer-events-none absolute top-10 left-1/2 -translate-x-1/2 text-[11px] tracking-[0.3em] text-bone/30 uppercase">
